...
fun HabitTool(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.fillMaxWidth().padding(horizontal = 20.dp, vertical = 16.dp)) {
            Row(
                ...
                Column {
                    ...
                    Text(
                            "$doneCount / ${habits.size} done today",
                ...
                Box(
                        modifier =
                                Modifier.clip(RoundedCornerShape(50.dp))
                                        .background(
                                                if (showAdd) SatriaColors.SurfaceMid
                        ...
                        Box(
                                modifier =
                                        Modifier.size(38.dp)
                                                .clip(CircleShape)
                                                .background(
                                                        if (newEmoji == emoji) SatriaColors.Accent
        ...
        LazyColumn(
                contentPadding =
                        PaddingValues(start = 20.dp, end = 20.dp, top = 0.dp, bottom = 20.dp),
