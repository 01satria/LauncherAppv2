...
fun DashboardScreen(
        vm: MainViewModel,
        onClose: () -> Unit,
        onPomodoroChanged: (Boolean) -> Unit = {}
) {
        ...
        val todoPending by remember {
                derivedStateOf { todos.count { !it.done }.takeIf { it > 0 } }
        }
        ...
        LaunchedEffect(showPomodoro) { onPomodoroChanged(showPomodoro) }

        DisposableEffect(showPomodoro) {
                activity?.requestedOrientation =
                        if (showPomodoro) ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED
        ...
        Box(
                modifier =
                        Modifier.fillMaxSize().background(SatriaColors.ScreenBackground).clickable(
                                        indication = null,
                                                        ...
                                                        when (tool) {
                                                                        ...
                                                                        WeatherTool(
                                                                                savedLocations =
                                                                                        vm.weatherLocations
                                                                                                ...
                                                                                                .value,
                                                                                onAddLocation = {
                                                                                        vm.addWeatherLocation(
                                                                                                it
                                                                                        )
                                                                                },
                                                                                onRemoveLocation = {
                                                                                        vm.removeWeatherLocation(
                                                                                                it
                                                                                        )
                                                                                }
                                                                        )
                                                                ...
                                                                "moneymanager" ->
                                                                        MoneyTool(
                                                                                ...
                                                                                onDeleteTransaction = {
                                                                                        vm.deleteMoneyTransaction(
                                                                                                it
                                                                                        )
                                                                                },
                                                                                onExportJson = {
                                                                                        vm.exportMoneyDataJson()
                                                                                },
                                                                                onImportJson = {
                                                                                        vm.importMoneyDataJson(
                                                                                                it
                                                                                        )
                                                                                },
                                                                        )
