...
fun SettingsSheet(vm: MainViewModel, onClose: () -> Unit) {
    ...
    val enableCustomRecents by vm.enableCustomRecents.collectAsState()
    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                SLabel("YOUR NAME")
                SField(tempName, { tempName = it }, "User")
                SLabel("ASSISTANT NAME")
                    ...
                    listOf("grid" to "⊞  Grid", "list" to "☰  List").forEach { (mode, label) ->
                        ...
                        TextButton(
                                ...
                                modifier =
                                        Modifier.weight(1f)
                                                .background(
                                                        if (active) SatriaColors.SurfaceHigh
                            ...
                            Text(
                                    label,
                                    color =
                                            if (active) SatriaColors.TextPrimary
                ...
                SToggle("Enable Custom Recents", enableCustomRecents) {
                    vm.setEnableCustomRecents(it)
                }
                        ...
                        (MIN_GRID_COLS..MAX_GRID_COLS).forEach { v ->
                            ...
                            Box(
                                ...
                                Text(
                                        "$v",
                                        color =
                                                if (active) androidx.compose.ui.graphics.Color.White
                                                else SatriaColors.TextSecondary,
                                        fontSize = 14.sp,
                                        fontWeight =
                    ...
                    OutlinedButton(
                            ...
                            colors =
                                    ButtonDefaults.outlinedButtonColors(
                                            contentColor = SatriaColors.TextSecondary
                                    ),
